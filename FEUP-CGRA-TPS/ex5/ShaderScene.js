class ShaderScene extends CGFscene {
    ...
    init(application) {
        ...
        this.testShaders = [
            ...
            new CGFshader(this.gl, "shaders/ex1.vert", "shaders/ex1.frag"),                     //9
            new CGFshader(this.gl, "shaders/texture1.vert", "shaders/ex12.frag"),               //10
        ...
        this.shadersList = {
            'Flat Shading': 0,'Passing a scale as uniform': 1,
