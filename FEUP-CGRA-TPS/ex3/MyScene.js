...
class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        //My variables
        this.scaleLightR = 1.0;
        this.scaleLightG = 1.0;
        this.scaleLightB = 1.0;
    ...
    display() {
        ...
        this.setGlobalAmbientLight(this.scaleLightR, this.scaleLightG, this.scaleLightB, 1.0);
