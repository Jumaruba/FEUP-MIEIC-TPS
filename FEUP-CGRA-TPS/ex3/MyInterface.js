...
class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        // light controler
        this.gui.add(this.scene, 'scaleLightR', 0.0, 1.0).name('ScaleRed');
        this.gui.add(this.scene, 'scaleLightG', 0.0, 1.0).name('ScaleGreen');
        this.gui.add(this.scene, 'scaleLightB', 0.0, 1.0).name('ScaleBlue');
